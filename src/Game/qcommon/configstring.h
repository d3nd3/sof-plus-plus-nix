...
#define	CS_SOUNDS			(CS_MODELS+MAX_MODELS) // 291
#define CS_EFFECTS			(CS_SOUNDS+MAX_SOUNDS) // 647
#define	CS_IMAGES			(CS_EFFECTS+MAX_EFPACKS) // 903
#define	CS_LIGHTS			(CS_IMAGES+MAX_IMAGES) // 1159
#define	CS_PLAYERSKINS		(CS_LIGHTS+MAX_LIGHTSTYLES) // 1415
#define	CS_PLAYERICONS		(CS_PLAYERSKINS+MAX_CLIENTS) // 1447
#define CS_STRING_PACKAGES	(CS_PLAYERICONS+MAX_PLAYERICONS) // 1463
